...
import { currency, dex, fixture, transactionErrorMessageContains, users } from "@gala-chain/test";
...
describe("GetPosition", () => {
  ...
  beforeEach(() => {
    ...
    positionOwnerData = new DexPositionOwner(users.testUser1Id, pool.genPoolHash());
  ...
  test("should fetch position data along with its metadata", async () => {
    ...
    const getUserPositionsDto = new GetUserPositionsDto(users.testUser1Id);
  ...
  test("should fetch next set of positions based on bookmark", async () => {
    ...
    const getUserPositionsDto = new GetUserPositionsDto(users.testUser1Id, "|1", 1);
  ...
  test("should check for invalid bookmarks", async () => {
    ...
    const getUserPositionsDto = new GetUserPositionsDto(users.testUser1Id, "|4", 1);
